...
// For digital Output:
int s1() { if(PINC&0x01) return 1; else return 0; } //leftmost, viewed from top;
int s2() { if(PINC&0x02) return 1; else return 0; }
int s3() { if(PINC&0x04) return 1; else return 0; }
int s4() { if(PINC&0x08) return 1; else return 0; }
int s5() { if(PINC&0x10) return 1; else return 0; }
